...
.project-container {
    display: flex;
    justify-content: space-between; /* Resimler arasında boşluk bırakmak için */
    max-width: 300px; /* Toplam genişlik (ihtiyaca göre ayarlayın) */
    margin-top: 20px; /* Yukarıdan bir boşluk eklemek için */
}
...
<div align="center">
    ...
    <div class="project-container">
        ...
        <div class="project">
            <img width="130" src="https://i.hizliresim.com/5pe3lwh.png" alt="Tap Mania Screenshot">
